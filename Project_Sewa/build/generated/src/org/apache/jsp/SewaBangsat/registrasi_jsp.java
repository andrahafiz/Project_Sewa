...
public final class registrasi_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<h4>Anda Sudah Memiliki Akun?</h4>\n");
      out.write("\t\t\t\t\t\t\t<p>Masuk Ke Menu Login Untuk Melakukan Login</p>\n");
      out.write("\t\t\t\t\t\t\t<a class=\"primary-btn\" href=\"login.jsp\">Klik Disini</a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"col-lg-6\">\n");
      out.write("\t\t\t\t\t<div class=\"login_form_inner\">\n");
      out.write("\t\t\t\t\t\t<h3>Registrasi</h3>\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"col-md-12 form-group\">\n");
      out.write("\t\t\t\t\t\t\t\t<textarea class=\"single-textarea\" placeholder=\"Alamat Rumah\" onfocus=\"this.placeholder = ''\" onblur=\"this.placeholder = 'Alamat Rumah'\"\n");
